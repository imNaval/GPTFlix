...
const moviesSlice = createSlice({
    ...
    reducers:{
        ...
        addMoviesWithGenres: (state, action) =>{
...
export const { addNowPlayingMovies, addPopularMovies, addTradingMovies, addUpcomingMovies, addTrailerVideo, addMovieVideos, addMovieDetails, addRelatedMovies, addRecommendationMovies, addMoviesWithGenres } = moviesSlice.actions;